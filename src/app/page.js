  ...
  const newsList = [
    {
      ...
      description:
        "Descubra dicas práticas para aumentar sua produtividade enquanto trabalha remotamente. Encontre o equilíbrio certo entre vida profissional e pessoal.",
    ...
    },
    {
      ...
      description:
        "Explore as últimas inovações tecnológicas que estão transformando o cenário atual. Saiba como essas tecnologias impactarão diferentes setores.",
      previewImageUrl: "https://picsum.photos/800/600",
